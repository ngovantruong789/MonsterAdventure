...
{
    [SerializeField] private MonsterDatabaseSO _monsterDatabaseSO;
    ...
    protected override void Configure(IContainerBuilder builder)
    {
        ...
        builder.RegisterEntryPoint<PlayerInventoryController>(Lifetime.Singleton).As<IPlayerInventoryProvider>();
        ...
        //File
        builder.RegisterInstance(_monsterDatabaseSO);
